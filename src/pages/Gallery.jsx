...
function Gallery() {
  const images = [
    ...
    },
    {
      ...
      title: "Urban Streets",
      category: "street",
      src: "https://images.unsplash.com/photo-1508057198894-247b23fe5ade?w=800",
    },
    {
      id: 7,
      title: "Night City",
    ...
    },
    {
      ...
      title: "Wild Tiger",
      category: "wildlife",
      src: "https://images.unsplash.com/photo-1546182990-dffeafbe841d?w=800",
    },
  ...
  }, [currentIndex, visibleImages, selectedImage]);
        ...
        {visibleImages.map((image, i) => (
          <div
            ...
            onClick={() => {
              ...
              setCurrentIndex(visibleImages.indexOf(image));
            }}
          >
            ...
            <div className="gal-overlay">
              ...
              <div className="gal-cat">{image.category.toUpperCase()}</div>
            </div>
          </div>
        ))}
      </div>
